...
| **UI**        | [Swing](https://docs.oracle.com/javase/tutorial/uiswing/) · [FlatLaf](https://www.formdev.com/flatlaf/) (flat light & dark themes) · [jsvg](https://github.com/weisJ/jsvg) (renders the SVG app icon) |
